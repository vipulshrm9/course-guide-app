...
/**
 * Created by shubham on 27/11/2017.
 */
...
public class CustomExpandableListAdapter1 extends BaseExpandableListAdapter {
    ...
    public Object getChild(int listPosition, int expandedListPosition) {
        return this.expandableListDetail1.get(this.expandableListTitle1.get(listPosition))
    ...
    public Object getGroup(int listPosition) {
        return this.expandableListTitle1.get(listPosition);
    }

    @Override
    public int getGroupCount() {
        return this.expandableListTitle1.size();
    }
